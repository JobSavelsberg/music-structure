...
> **⚠️ DISCLAIMER**: Spotify has closed their audio analysis API, rendering this project non-functional. An improved version was being developed at [musivis](https://github.com/JobSavelsberg/musivis) but was also discontinued. No suitable alternatives to the Spotify API have been found.
...
![tool_image](https://jobsavelsberg.com/images/musicstructure.png "Tool")
