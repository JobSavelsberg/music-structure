    ...
    <div>
      ...
      >
        ...
        />
            ...
            <canvas id="gl-canvas" :height="canvasWidth" :width="canvasWidth" class="visCanvas pa-0 ma-0"></canvas>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        clickedCluster(clusterIndex, segment) {
            log.debug("playing cluster", clusterIndex);
            let totalDuration = 0;
